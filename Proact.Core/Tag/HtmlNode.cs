...
public abstract class HtmlNode
{
    ...
    public static implicit operator HtmlNode(DynamicValue<string> value) => value.On(v => Tags.span()(v));
    public static implicit operator HtmlNode(DynamicValue<int> value) => value.On(v => Tags.span()(v+""));
