...
public static class Tags
{
    ...
    public static HtmlTagFunc input(string? klass = null, string? type = null, string? name = null, string? oninput = null, string? style = null, string? id = null, bool? hidden = null, string? onclick = null)
    {
        return children => new HtmlTag("input", children).Add("class",klass).Add("type",type).Add("name",name).Add("oninput",oninput).Add("style",style).Add("id",id).Add("hidden",hidden).Add("onclick",onclick);
    }
...
{
    public Input(string? klass = null, string? type = null, string? name = null, string? oninput = null, string? style = null, string? id = null, bool? hidden = null, string? onclick = null) : base("input")
    {
        this.Add("class",klass).Add("type",type).Add("name",name).Add("oninput",oninput).Add("style",style).Add("id",id).Add("hidden",hidden).Add("onclick",onclick);
    }
}
